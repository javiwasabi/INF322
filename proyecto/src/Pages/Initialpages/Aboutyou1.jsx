      ...
      <div className="relative flex items-center justify-center min-h-screen bg-white overflow-hidden">
        ...
        <div className="z-10 text-center space-y-6">
          ...
          <p>Cuéntame más sobre ti</p>
                ...
                <p className=" text-gray-600 text-sm font-poppins md:text-s">¿cómo te llamas?</p>
                <CustomButton label="Escribe tu nombre" onClick={handleBack} className="w-full h-12 text-lg" />
            </div>
            <div className="flex flex-col items-center space-y-6 mt-[10%] w-full">
                <p className=" text-gray-600 text-sm font-poppins md:text-s">¿cómo se llama tu hijo/a?</p>

                <CustomButton label="Escribe el nombre de tu hijo/a" onClick={handleBack} className="w-full h-12 text-lg" />
            </div>
          </div>

          <PrevButton label="Devolverse" target="/" />
          <NextButton label="Siguiente" target="/aboutyou2" />
